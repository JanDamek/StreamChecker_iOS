...
- (void)viewDidLoad {
  ...
  self.view.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"FormatViewController_Image_1.png"]];
  ...
  navigationBar1.topItem.title = @"Format";
  ...
  UITableViewCell *tableViewCell1 = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:nil];
    tableViewCell1.textLabel.text = [checkerDataManager formatTypToString:MP3];
    tableViewCell1.tag = MP3;
  ...
  tableViewCell2.textLabel.text = [checkerDataManager formatTypToString:AAC];
    tableViewCell2.tag = AAC;
  ...
  tableViewCell3.textLabel.text = [checkerDataManager formatTypToString:OOG];
    tableViewCell3.tag = OOG;
  tableViewCell3.detailTextLabel.text = @"";
  ...
  UISegmentedControl *segmentedControl1 = [[UISegmentedControl alloc] initWithFrame:CGRectMake(30, 342, 150, 44)];
  ...
  [segmentedControl1 setSelectedSegmentIndex:0];
    ...
    UIView *webView1 = [[UIView alloc] initWithFrame:CGRectMake(0, 360, 320, 50)];
