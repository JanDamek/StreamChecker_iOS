...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"HomeViewController_Image_1.png"]];
    ...
    UITabBarItem *tabBarItem1 = [[UITabBarItem alloc] initWithTitle:@"Home" image:[UIImage imageNamed:@"HomeViewController_Image_2.png"] tag:1];
    ...
    UITabBarItem *tabBarItem2 = [[UITabBarItem alloc] initWithTitle:@"Info" image:[UIImage imageNamed:@"HomeViewController_Image_3.png"] tag:2];
    ...
    UITabBarItem *tabBarItem3 = [[UITabBarItem alloc] initWithTitle:@"History" image:[UIImage imageNamed:@"HomeViewController_Image_4.png"] tag:3];
    ...
    UITabBarItem *tabBarItem4 = [[UITabBarItem alloc] initWithTitle:@"Settings" image:[UIImage imageNamed:@"HomeViewController_Image_5.png"] tag:4];
    
    tabBar1.items = [NSArray arrayWithObjects:tabBarItem1, tabBarItem2, tabBarItem3, tabBarItem4, nil];
    
    tabBar1.selectedItem = tabBarItem1;
    ...
    _tableView1 = [[UITableView alloc] initWithFrame:CGRectMake(0, 44, 320, 319) style:UITableViewStylePlain];
    _tableView1.tag = 1;
    _tableView1.delegate = (id<UITableViewDelegate>)self;
    _tableView1.dataSource = (id<UITableViewDataSource>)self;
    self.tableView1Data = [NSMutableArray array];
    [contentView addSubview:_tableView1];
    _tableView1.alpha = 1.0;
    ...
    _tableView1.separatorColor = [UIColor colorWithRed:0.37 green:0.75 blue:1.0 alpha:1.0];
    _tableView1.backgroundColor = [UIColor colorWithRed:0.98 green:1.0 blue:1.0 alpha:1.0];  
    ...
    [tableViewSection1Data setObject:@"Radio mounts" forKey:@"headerText"];
    ...
    navigationBar1.topItem.title = @"Home";
    [navigationBar1 setTitleVerticalPositionAdjustment:0.0 forBarMetrics:UIBarMetricsDefault];
    
    // ----------------------------;
    // Navigation Bar Lef Button -> barButton2;
    // ----------------------------;
    
    UIBarButtonItem *barButton2 = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemEdit target:nil action:nil];
    barButton2.target = self;
    barButton2.action = @selector(didTap_barButton2:forEvent:);
    
    navigationBar1.topItem.leftBarButtonItem = barButton2;
    
    // ----------------------------;
    // Navigation Bar Right Button -> barButton1;
    // ----------------------------;
    
    UIBarButtonItem *barButton1 = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemAdd target:nil action:nil];
...
-(void)viewDidDisappear:(BOOL)animated{
    ...
    [self removeObserver:_data forKeyPath:@"streamStatusChange"];
}
...
-(void)initData{
    ...
    NSMutableDictionary *tableViewSection1Data = [tableView1Data objectAtIndex:0];
    [[tableViewSection1Data objectForKey:@"cells"] removeAllObjects];
    
    for (int i=0; i<[_data.streams count]; i++) {
        _data.aktStream = i;
        
        NSMutableDictionary *tableViewCell1Data = [NSMutableDictionary dictionary];
        UITableViewCell *tableViewCell1 = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:nil];
        tableViewCell1.textLabel.text = [_data.name stringByAppendingFormat:@" - %@",[checkerDataManager streamStateToString:_data.state]];
        tableViewCell1.detailTextLabel.text = _data.url;
        tableViewCell1.accessoryType = UITableViewCellAccessoryDetailDisclosureButton;
        if (_data.state == WORKING){
            tableViewCell1.imageView.image = [UIImage imageNamed:@"HomeViewController_Image_7.png"];} else {
            tableViewCell1.imageView.image = [UIImage imageNamed:@"HomeViewController_Image_6.png"];            }
        tableViewCell1.backgroundColor = [UIColor colorWithRed:1.0 green:0.0 blue:0.0 alpha:1.0];
        tableViewCell1.textLabel.textColor = [UIColor colorWithRed:0.0 green:1.0 blue:0.0 alpha:1.0];
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [self addObserver:_data forKeyPath:@"streamStatusChange" options:0 context:nil];    
}
...
{
    _data.aktStream = indexPath.row;
    AddStreamView2ViewController *controller = [[AddStreamView2ViewController alloc] init];
...
- (void)didTap_barButton1:(id)sender forEvent:(UIEvent *)event {
    ...
    [_data.streams addObject:[[NSMutableDictionary alloc]init]];
    _data.aktStream = [_data.streams count]-1;
